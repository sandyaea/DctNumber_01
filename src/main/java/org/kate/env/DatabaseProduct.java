...
public enum DatabaseProduct {
    ...
    H2(
        ...
        org.kate.shared.ImprovedH2Dialect.class.getName()
    ),
            ...
            public void configure(PoolingDataSource ds, String connectionURL) {
                ...
                ds.getDriverProperties().put(
                    ...
                    connectionURL != null
                        ...
                        //"jdbc:mysql://localhost/DctNumber_01?useSSL=false"
                        "jdbc:mysql://localhost/DctNumber_01?useSSL=false&sessionVariables=sql_mode='PIPES_AS_CONCAT'"
                );

                ds.getDriverProperties().put("driverClassName", "com.mysql.cj.jdbc.Driver");
                ds.getDriverProperties().put("user", "javauser");
                ds.getDriverProperties().put("password", "javauser");
            }
        },
